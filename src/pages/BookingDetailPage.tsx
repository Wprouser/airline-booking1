  ...
  return (
    <div className="mx-auto max-w-3xl animate-slide-up">
      ...
      <Card className="mb-6">
        ...
        {booking.legs.map((leg) => (
          <div key={leg.id} className="mb-3 border-b border-slate-100 pb-3 text-sm last:mb-0 last:border-0 last:pb-0 dark:border-slate-800">
            ...
            <div className="text-slate-400 dark:text-slate-500">{formatMoney(leg.farePrice)} per passenger</div>
          </div>
        ))}
      </Card>
      ...
      <Card className="mb-6">
        ...
        <div className="mt-2 text-lg font-bold text-slate-800 dark:text-white">Total Paid: {formatMoney(booking.totalAmount)}</div>
      </Card>
